...
export default {
	...
	methods:{
		...
		toJudge(event){
			if(this._$UMSTORE._uobj_dropdown.nowConditionId_dropdown!==null && this._$UMSTORE._uobj_dropdown.nowConditionId_dropdown!==this.num && this._$UMSTORE._uobj_dropdown.nowConditionObj_dropdown!==null){
				this._$UMSTORE._uobj_dropdown.nowConditionObj_dropdown.fold();
