...
export default {
	data(){
		return {
            ...
            inputRulesObj:{
            	...
            	'dropdownValue1':['required|不能为空(下拉框测试1)'],
            	'dropdownValue2':['required|不能为空(下拉框测试2)'],
            	'dropdownValue3':['required|不能为空(下拉框测试3)']
            },
            switchValue:'T',
            modal:false,
	...
	mounted:function(){
		setTimeout(()=>{
			...
			this.dropdownValue2='ccc';
			this.dropdownValue3={name:'bbb', id:1, unit:'km'};
...
<style>
.dropdown_view {width:75%; padding:5%; background:#FAFAFA; position:absolute; left:10%; top:20px;}
</style>