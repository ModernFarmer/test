...
<div class="dropdown_view">
	...
	<br><br><br>
	<um-page total="1000" size="10" sizeable skipable @change="pageChange" @sizeChange="sizeChange"></um-page>
</div>
</template>
...
// closeSearchClear: 关闭本地搜索的清除功能; 当插件有searchable属性时, 如果收起下拉框, 默认会清除搜索框内的搜索关键字, 如果有closeSearchClear属性, 则不会清除
