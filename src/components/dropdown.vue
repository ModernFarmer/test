...
// model: 配合v-model使用, 可以指定绑定v-model所抛出的值的属性. 比如说你选择的选项的绑定值为{key:'a', value:{v1:'aaa', v2:'bbb'}, name:'c'}, 但是你只想得到这个json的value里面的v1的值, 那么你可以设置model为'value.v1', 那么你就可以方便地得到你想要地值, 而不用自己通过@change的自定义方法去处理数据    [string]
